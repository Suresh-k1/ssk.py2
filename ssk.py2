...
\033[ \______/  \______/ |__/  \__/                         

\033[1;92mâ•”â•â•o00â•â•â•â•â•â•â•â•00oâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—

\033[1;31;1mâ–ˆ \033[1;92m [â€¢] \033[1;31;1mAuthor    :  \033[1;92m SSK_   \033[1;31;1m â–ˆ

\033[1;31;1mâ–ˆ \033[1;92m [â€¢] \033[1;31;1mWhatsapp  :  \033[1;92m 03476858551        \033[1;31;1m â–ˆ

\033[1;31;1mâ–ˆ \033[1;92m [â€¢] \033[1;31;1mGitHub    : \033[1;92m  Sureshk1_    \033[1;31;1m â–ˆ

\033[1;31;1mâ–ˆ \033[1;92m [â€¢] \033[1;31;1mGorup Fb  :   \033[1;92m None \033[1;31;1m â–ˆ
...
def hasil(ok,cp):
    ...
    if len(ok) != 0 or len(cp) != 0:
        ...
        print(f' %s[%s+%s] Number of Accounts OK : %s%s%s'%(H,H,H,H,str(SSK(ok)),H))

        print(f' [%s+%s] Number of Accounts CP : %s%s%s'%(H,H,H,str(SSK(cp)),H))
...
class __chigoue__:
    ...
    def __metode__(self, cebok, user, pasw):
        ...
        sys.stdout.write(f"\r {N}{SSK} {N}{loop}{N}/{M}{len(self.id)} {N}[{H}OK:{len(ok)}{N}][{K}CP:{len(cp)}{N}] [{H}{'{:.1%}'.format(loop/float(len(self.id)))}{N}]")
